...
function FleetViewTable(props) {
  ...
  const columns = [
    columnHelper.accessor("vehicle", {
      id: "vehicle",
      header: () => (
        <p className="text-sm font-bold text-gray-600 dark:text-white">VEHICLE</p>
      ),
      cell: (info) => (
    ...
    columnHelper.accessor("fuel level", {
      id: "fuel level",
      header: () => (
        <p className="text-sm font-bold text-gray-600 dark:text-white">FUEL LEVEL</p>
      ),
      cell: (info) => (
        <p className="text-sm font-bold text-navy-700 dark:text-white">
          {info.getValue()}
    ...
    columnHelper.accessor("over speed", {
      id: "over speed",
      header: () => (
        <p className="text-sm font-bold text-gray-600 dark:text-white">OVER SPEED</p>
      ),
      cell: (info) => (
        <p className="text-sm font-bold text-navy-700 dark:text-white">
          {info.getValue()}
    ...
    columnHelper.accessor("accident", {
      id: "accident",
      header: () => (
        <p className="text-sm font-bold text-gray-600 dark:text-white">ACCIDENT</p>
      ),
      cell: (info) => (
        <p className="text-sm font-bold text-navy-700 dark:text-white">
          {info.getValue()}
